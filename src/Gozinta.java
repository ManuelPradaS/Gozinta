...
public class Gozinta {
    ...
    static ArrayList<ArrayList<Long>> getGozintaChains(long destinationNode){
        long initialNode=1;
    ...
    public static void main(String[] args) {
       ...
       do {
        ...
        ArrayList<ArrayList<Long>> CurrentChainList=getGozintaChains(destinationNode);

        System.out.println("Number of chains g(n):"+ CurrentChainList.size());
        System.out.println("Gozinta chains for n="+ destinationNode+":");
        System.out.println(CurrentChainList);
    }
